package com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.filter;

import android.content.res.Resources;
import android.opengl.GLES20;


import com.fahimfarhan.simplevideoeditor.gpuimage.utils.OpenGlUtils;
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.gl.GlFramebufferObject;
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.utils.EglUtil;
...
public class GlFilter {
    ...
    public void setup() {
        ...
        glAttribPosition = GLES20.glGetAttribLocation(program, "position");
        glUniformTexture = GLES20.glGetUniformLocation(program, "inputImageTexture");
        glAttribTextureCoordinate = GLES20.glGetAttribLocation(program, "inputTextureCoordinate");
