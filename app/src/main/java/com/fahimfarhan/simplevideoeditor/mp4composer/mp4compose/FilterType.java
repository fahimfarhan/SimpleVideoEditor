...
import org.mainstring.textee.ui.videoeditor.imageutil.GPUImageFilterTools.ImageFilterType;

import com.fahimfarhan.simplevideoeditor.R;
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.filter.*;
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.gl.GlBitmapOverlaySample;
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.gl.GlPixelationFilter;
...
//    VIGNETTE, WEAK_PIXEL, WHITE_BALANCE, ZOOM_BLUR
    ...
    public static ArrayList<Pair<FilterType, ImageFilterType> > getFilterPairs() {
        ArrayList<Pair<FilterType, ImageFilterType> > arraylist = new ArrayList<>();
        arraylist.add(new Pair<>(DEFAULT, ImageFilterType.DEFAULT));
        arraylist.add(new Pair<>(BILATERAL_BLUR,ImageFilterType.BILATERAL_BLUR));
        arraylist.add(new Pair<>(BOX_BLUR,ImageFilterType.BOX_BLUR));
        arraylist.add(new Pair<>(BRIGHTNESS,ImageFilterType.BRIGHTNESS));
        arraylist.add(new Pair<>(BULGE_DISTORTION,ImageFilterType.BULGE_DISTORTION));
        arraylist.add(new Pair<>(CGA_COLORSPACE,ImageFilterType.CGA_COLORSPACE));
        arraylist.add(new Pair<>(CONTRAST,ImageFilterType.CONTRAST));
        arraylist.add(new Pair<>(CROSSHATCH,ImageFilterType.CROSSHATCH));
        arraylist.add(new Pair<>(EXPOSURE,ImageFilterType.EXPOSURE));
        arraylist.add(new Pair<>(FILTER_GROUP_SAMPLE,ImageFilterType.FILTER_GROUP));

        arraylist.add(new Pair<>(GAMMA,ImageFilterType.GAMMA));
        arraylist.add(new Pair<>(GAUSSIAN_FILTER,ImageFilterType.GAUSSIAN_BLUR));
        arraylist.add(new Pair<>(GRAY_SCALE,ImageFilterType.GRAYSCALE));
        arraylist.add(new Pair<>(HALFTONE,ImageFilterType.HALFTONE));
        arraylist.add(new Pair<>(HAZE,ImageFilterType.HAZE));
        arraylist.add(new Pair<>(HIGHLIGHT_SHADOW,ImageFilterType.HIGHLIGHT_SHADOW));

        arraylist.add(new Pair<>(HUE,ImageFilterType.HUE));
        arraylist.add(new Pair<>(INVERT,ImageFilterType.INVERT));
        arraylist.add(new Pair<>(LUMINANCE,ImageFilterType.LUMINANCE));
        arraylist.add(new Pair<>(LUMINANCE_THRESHOLD,ImageFilterType.LUMINANCE_THRESHSOLD));
        arraylist.add(new Pair<>(MONOCHROME,ImageFilterType.MONOCHROME));
        arraylist.add(new Pair<>(OPACITY,ImageFilterType.OPACITY));
        arraylist.add(new Pair<>(OVERLAY,ImageFilterType.BLEND_OVERLAY));
        arraylist.add(new Pair<>(PIXELATION,ImageFilterType.PIXELATION));
        arraylist.add(new Pair<>(POSTERIZE,ImageFilterType.POSTERIZE));
        arraylist.add(new Pair<>(RGB,ImageFilterType.RGB));
        arraylist.add(new Pair<>(SATURATION,ImageFilterType.SATURATION));
        arraylist.add(new Pair<>(SEPIA,ImageFilterType.SEPIA));
        arraylist.add(new Pair<>(SHARP,ImageFilterType.SHARPEN));

        arraylist.add(new Pair<>(SOLARIZE,ImageFilterType.SOLARIZE));
        arraylist.add(new Pair<>(SPHERE_REFRACTION,ImageFilterType.SPHERE_REFRACTION));
        arraylist.add(new Pair<>(SWIRL,ImageFilterType.SWIRL));
        arraylist.add(new Pair<>(TONE_CURVE_SAMPLE,ImageFilterType.TONE_CURVE));
        arraylist.add(new Pair<>(VIBRANCE,ImageFilterType.VIBRANCE));

        arraylist.add(new Pair<>(VIGNETTE,ImageFilterType.VIGNETTE));
        arraylist.add(new Pair<>(WEAK_PIXEL,ImageFilterType.WEAK_PIXEL_INCLUSION));
        arraylist.add(new Pair<>(WHITE_BALANCE,ImageFilterType.WHITE_BALANCE));
        arraylist.add(new Pair<>(ZOOM_BLUR,ImageFilterType.ZOOM_BLUR));
