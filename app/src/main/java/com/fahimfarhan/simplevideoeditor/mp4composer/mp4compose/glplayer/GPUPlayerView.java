...
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.gl.GlConfigChooser;
import com.fahimfarhan.simplevideoeditor.mp4composer.mp4compose.gl.GlContextFactory;
...
public class GPUPlayerView extends GLSurfaceView implements VideoListener {
    ...
    protected float videoAspect = 1f;
