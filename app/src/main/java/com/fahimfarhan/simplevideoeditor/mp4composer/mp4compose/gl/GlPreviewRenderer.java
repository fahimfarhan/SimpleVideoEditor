...
public class GlPreviewRenderer {
    // todo: Most probably this one is used in camera live video
    //       since we dont need camera, comment out this one to reduce dependency issues
}
